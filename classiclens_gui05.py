...
def create_round_shadow_button(text, command):
    ...
    shadow = tk.Frame(frame, bg="#d9d9d9", width=220, height=48)
    shadow.pack(pady=(4, 0))

    btn = tk.Button(shadow, text=text, command=command,
                    width=24, height=2,
                    bg="#ffffff", fg="#212529",
    ...
    frame.inner_btn = btn  # 실제 버튼에 접근할 수 있도록 저장
    return frame
